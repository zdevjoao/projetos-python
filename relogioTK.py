...
saudacao =  Label(root, bg='#1d1d1d', fg='#8B0000', font=('Montserrat', 16), text='Olá')
saudacao.pack()

data = Label(root, bg='#1d1d1d', fg='#8B0000', font=('Montserrat', 14))
data.pack(pady=2)

horas = Label(root, bg='#1d1d1d', fg='#8B0000', font=('Montserrat', 64, 'bold'))
horas.pack(pady=2)
